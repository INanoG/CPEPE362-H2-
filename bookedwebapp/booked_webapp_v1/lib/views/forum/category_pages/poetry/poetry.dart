...
class poetryGenre extends StatefulWidget {
  final int entrynum;
  poetryGenre({required this.entrynum});

  @override
  _poetryGenre createState() => _poetryGenre();
}
...
class _poetryGenre extends State<poetryGenre> {
  @override
