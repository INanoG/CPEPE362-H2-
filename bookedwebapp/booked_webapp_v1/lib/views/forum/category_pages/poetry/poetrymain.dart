...
import 'package:booked_webapp_v1/views/forum/category_pages/poetry/poetry.dart';
...
class PoetryView extends StatelessWidget {
  const PoetryView({Key? key}) : super(key: key);
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => poetryGenre(entrynum: count),
            ),
          );
        },
      ),
