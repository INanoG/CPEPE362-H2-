...
import 'package:booked_webapp_v1/views/forum/category_pages/humor/humor_forum.dart';
...
class HumorView extends StatelessWidget {
  const HumorView({Key? key}) : super(key: key);
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => humorGenre(entrynum: count),
            ),
          );
        },
      ),
