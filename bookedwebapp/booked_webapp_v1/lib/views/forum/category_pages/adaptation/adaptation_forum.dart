...
class adaptationGenre extends StatefulWidget {
  final int entrynum;
  adaptationGenre({required this.entrynum});

  @override
  _adaptationGenre createState() => _adaptationGenre();
}
...
class _adaptationGenre extends State<adaptationGenre> {
  @override
