import 'package:booked_webapp_v1/views/forum/category_pages/adaptation/adaptation_forum.dart';
...
class AdaptationView extends StatelessWidget {
  const AdaptationView({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          primary: Color.fromARGB(255, 145, 112, 82),
                          elevation: 2,
                          onPrimary: const Color.fromARGB(255, 59, 41, 25),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(5.0),
            ...
            const Text(
              'Discussions for Adaptation Genre',
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => adaptationGenre(entrynum: count),
            ),
          );
        },
      ),
