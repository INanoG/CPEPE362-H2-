...
import 'package:booked_webapp_v1/views/forum/category_pages/mythology/mythology_forum.dart';
...
class MythologyView extends StatelessWidget {
  const MythologyView({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Discussions for Mythology Genre',
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => mythologyGenre(entrynum: count),
            ),
          );
        },
      ),
