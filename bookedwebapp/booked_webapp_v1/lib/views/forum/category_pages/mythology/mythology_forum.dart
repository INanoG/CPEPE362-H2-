...
class mythologyGenre extends StatefulWidget {
  final int entrynum;
  mythologyGenre({required this.entrynum});

  @override
  _mythologyGenre createState() => _mythologyGenre();
}
...
class _mythologyGenre extends State<mythologyGenre> {
  @override
