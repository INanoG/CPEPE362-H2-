...
class biographyGenre extends StatefulWidget {
  final int entrynum;
  biographyGenre({required this.entrynum});

  @override
  _biographyGenre createState() => _biographyGenre();
}
...
class _biographyGenre extends State<biographyGenre> {
  @override
