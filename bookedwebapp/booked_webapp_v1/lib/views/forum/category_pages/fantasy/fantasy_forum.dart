...
class fantasyGenre extends StatefulWidget {
  final int entrynum;
  fantasyGenre({required this.entrynum});

  @override
  _fantasyGenre createState() => _fantasyGenre();
}
...
class _fantasyGenre extends State<fantasyGenre> {
  @override
