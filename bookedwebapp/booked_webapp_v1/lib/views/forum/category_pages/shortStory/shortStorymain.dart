...
import 'package:booked_webapp_v1/views/forum/category_pages/shortStory/shortStory_forum.dart';
...
class ShortStoryView extends StatelessWidget {
  const ShortStoryView({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Discussions for Short Story Genre',
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => shortStoryGenre(entrynum: count),
            ),
          );
        },
      ),
