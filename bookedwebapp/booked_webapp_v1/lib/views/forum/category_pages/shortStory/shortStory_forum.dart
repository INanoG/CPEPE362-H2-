...
class shortStoryGenre extends StatefulWidget {
  final int entrynum;
  shortStoryGenre({required this.entrynum});

  @override
  _shortStoryGenre createState() => _shortStoryGenre();
}
...
class _shortStoryGenre extends State<shortStoryGenre> {
  @override
