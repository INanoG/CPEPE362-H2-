...
class romanceGenre extends StatefulWidget {
  final int entrynum;
  romanceGenre({required this.entrynum});

  @override
  _romanceGenre createState() => _romanceGenre();
}
...
class _romanceGenre extends State<romanceGenre> {
  @override
