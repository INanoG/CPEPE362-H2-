...
import 'package:booked_webapp_v1/views/forum/category_pages/fairytale/fairytale_forum.dart';
...
class FairyTaleView extends StatelessWidget {
  const FairyTaleView({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Discussions for Fairy Tale Genre',
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => fairytaleGenre(entrynum: count),
            ),
          );
        },
      ),
