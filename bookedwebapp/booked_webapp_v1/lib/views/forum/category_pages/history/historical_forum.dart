...
class historicalGenre extends StatefulWidget {
  final int entrynum;
  historicalGenre({required this.entrynum});

  @override
  _historicalGenre createState() => _historicalGenre();
}
...
class _historicalGenre extends State<historicalGenre> {
  @override
