...
import 'package:booked_webapp_v1/views/forum/category_pages/history/historical_forum.dart';
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => historicalGenre(entrynum: count),
            ),
          );
        },
      ),
