...
class fictionGenre extends StatefulWidget {
  final int entrynum;
  fictionGenre({required this.entrynum});

  @override
  _fictionGenre createState() => _fictionGenre();
}
...
class _fictionGenre extends State<fictionGenre> {
  @override
