...
import 'package:booked_webapp_v1/views/forum/category_pages/fiction/fiction_forum.dart';
...
class FictionView extends StatelessWidget {
  const FictionView({Key? key}) : super(key: key);
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => fictionGenre(entrynum: count),
            ),
          );
        },
      ),
